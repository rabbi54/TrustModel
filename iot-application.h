#ifndef WAVETEST_IOT_APPLICATION_H
#define WAVETEST_IOT_APPLICATION_H
...
namespace ns3
{
    ...
    */
    ...
    class IoTApplication : public ns3::Application
    {
        public: 
        ...
        private:
            ...
            // double max_service_time_delay = 20; // into miliseconds
            ...
            double max_service_time_delay = 20.0; // into miliseconds
